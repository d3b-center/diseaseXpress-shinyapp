...
#             'samples.transcripts.sample_abundance.tpm',
#             'gene_info.transcripts.biotype')
# samp_ids <- 'SRR1310210'


get.transcript.data.kallisto <- function(index, type, genes, fields, samp_ids){
  ...
  set.fields <- c('samples.sample_id','samples.transcripts.transcript_id','samples.transcripts.sample_abundance.tpm','gene_info.symbol')
  if(length(fields)>0){
